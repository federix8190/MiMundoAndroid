...
/**
 * Created by Konecta on 16/10/2015.
 */
public class InfoGrupoAdapter extends ArrayAdapter<DatoPerfil> {

    private final static int RESOURCE_LAYOUT = R.layout.item_info_grupo ;
    private Typeface tf;

    public InfoGrupoAdapter(Context context, List<DatoPerfil> items) {
