 ...
 */
public class NumerosGratisFragment extends Fragment {

    private String linea;
    private static final String FRAGMENT_NAME = "NumerosGratisFragment";
    ...
    public static NumerosGratisFragment newInstance() {
        return new NumerosGratisFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        activity.setTitle("Destinos Gratuitos");
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogFragment dialogo = MensajesGenericosAceptarRechazar.newInstance(
                        ...
                        "", false);
                dialogo.setTargetFragment(NumerosGratisFragment.this, DESTINOS_GRATUITOS_CREAR_DIALOG_1);
