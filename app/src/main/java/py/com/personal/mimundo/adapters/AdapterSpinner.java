...
public class AdapterSpinner extends BaseAdapter {
    ...
    public AdapterSpinner(boolean mTopLevel, Activity context) {
    ...
    public View getDropDownView(int position, View view, ViewGroup parent) {
        if (view == null || !view.getTag().toString().equals("DROPDOWN")) {
            view = context.getLayoutInflater().inflate(R.layout.explore_spinner_item_dropdown, parent, false);
    ...
    public View getView(int position, View view, ViewGroup container) {
        if (view == null || !view.getTag().toString().equals("NON_DROPDOWN")) {
            ...
            view = inflater.inflate(mTopLevel ? R.layout.spinner_item_edit : R.layout.explore_spinner_item, container, false);
