 ...
 */
public abstract class ItemStanby {
     ...
     *
     * @param context The Context in which the {@link py.com.personal.mimundo.widget.itemview.ItemViewStanby} will be used
     ...
     */
    public abstract ItemViewStanby newView(Context context, ViewGroup parent);
     ...
     */
    protected static ItemViewStanby createCellFromXml(Context context, int layoutID, ViewGroup parent) {
        return (ItemViewStanby) LayoutInflater.from(context).inflate(layoutID, parent, false);
    }
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs) throws XmlPullParserException, IOException {
        TypedArray a = r.obtainAttributes(attrs, R.styleable.ItemStanby);
        enabled = a.getBoolean(R.styleable.ItemStanby_enabled, enabled);
        a.recycle();
    }
