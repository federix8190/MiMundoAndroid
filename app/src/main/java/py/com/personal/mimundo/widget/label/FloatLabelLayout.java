package py.com.personal.mimundo.widget.label;
...
public class FloatLabelLayout extends LinearLayout {
    ...
    public FloatLabelLayout(Context context, AttributeSet attrs, int defStyle) {
        // TODO: verificar este constructor, el original era = super(context, attrs, defStyle);
        // que esta habilitado para la API 11 o superior
        super(context, attrs);
    ...
    private void updateLabelVisibility(boolean animate) {
        ...
        // TODO: no habilitado para APIs inferiores a la 11, ademas no esta claro la funcionalidad
        // de activar los hijos del label.
