 ...
 */
public class RelativeLayout1 extends RelativeLayout {

    private Paint linePaint;

    public RelativeLayout1(Context context) {
        super(context);
        init();
    }

    public RelativeLayout1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RelativeLayout1(Context context, AttributeSet attrs, int defStyle) {
